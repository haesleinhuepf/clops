 ...
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_minimumThreshold")
public class MinimumThreshold extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.threshold().minimum(asImg(args[0]));
