...
/**
 * The MaxEntropyThreshold
 *
 * Author: @haesleinhuepf
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_maxEntropyThreshold")
public class MaxEntropyThreshold extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.threshold().maxEntropy(asImg(args[0]));
