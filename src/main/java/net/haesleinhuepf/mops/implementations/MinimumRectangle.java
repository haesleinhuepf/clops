...
/**
 * The MinimumRectangle
 *
 * Author: @haesleinhuepf
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_minimumRectangle")
public class MinimumRectangle extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.filter().min(asImg(args[0]), asImg(args[1]), asRectangle(args[2]));
