...
/**
 * The VarianceRectangle
 *
 * Author: @haesleinhuepf
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_varianceRectangle")
public class VarianceRectangle extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.filter().variance(asImg(args[0]), asImg(args[1]), asRectangle(args[2]));
