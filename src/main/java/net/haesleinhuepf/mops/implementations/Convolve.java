 ...
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_convolve")
public class Convolve extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.filter().convolve(asImg(args[0]), asImg(args[1]));
    ...
    public String getParameters() {
        return "Image input, Image kernel";
    }
