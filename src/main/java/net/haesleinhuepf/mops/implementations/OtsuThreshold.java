 ...
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_otsuThreshold")
public class OtsuThreshold extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.threshold().otsu(asImg(args[0]));
