...
/**
 * The IntermodesThreshold
 *
 * Author: @haesleinhuepf
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_intermodesThreshold")
public class IntermodesThreshold extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.threshold().intermodes(asImg(args[0]));
