...
/**
 * The MinErrorThreshold
 *
 * Author: @haesleinhuepf
 * 6 2019
 */
@Plugin(type = CLIJMacroPlugin.class, name = "MOPS_minErrorThreshold")
public class MinErrorThreshold extends MopsBase implements OffersDocumentation {

    @Override
    public RandomAccessibleInterval run() {
        RandomAccessibleInterval result = (Img)ops.threshold().minError(asImg(args[0]));
